...
public class HelpTextAutoBuildFix
{
    ...
    public void HelpText_with_AdditionalNewLineAfterOption_true_should_have_newline()
    {
        // Fixture setup
        // Exercize system 
        HelpText sut = new HelpText { AdditionalNewLineAfterOption = true }.AddOptions(
    ...
    public void HelpText_with_AdditionalNewLineAfterOption_false_should_not_have_newline()
    {
        // Fixture setup
        // Exercize system 
        HelpText sut = new HelpText { AdditionalNewLineAfterOption = false }.AddOptions(
            new NotParsed<Simple_Options>(TypeInfo.Create(typeof(Simple_Options)), Enumerable.Empty<Error>()));
    ...
    public void HelpText_with_by_default_should_include_help_version_option()
    {
        // Fixture setup
        // Exercize system 
        HelpText sut = new HelpText().AddOptions(
            new NotParsed<Simple_Options>(TypeInfo.Create(typeof(Simple_Options)), Enumerable.Empty<Error>()));
    ...
    public void HelpText_with_AutoHelp_false_should_hide_help_option()
    {
        // Fixture setup
        // Exercize system 
        HelpText sut = new HelpText { AutoHelp = false, AutoVersion = false }.AddOptions(
            new NotParsed<Simple_Options>(TypeInfo.Create(typeof(Simple_Options)), Enumerable.Empty<Error>()));
