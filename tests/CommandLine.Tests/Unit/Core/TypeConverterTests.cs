...
public class TypeConverterTests
{
    ...
    {
        var result = TypeConverter.ChangeType(
            new[] { testValue },
            destinationType,
            true,
            false,
    ...
    public static IEnumerable<object[]> ChangeType_scalars_source
    {
        get
        {
            return new[]
            {
                new object[] { "1", typeof(int), false, 1 }, new object[] { "0", typeof(int), false, 0 },
                new object[] { "-1", typeof(int), false, -1 }, new object[] { "abcd", typeof(int), true, null },
                ...
                new object[] { "true", typeof(bool), false, true }, new object[] { "True", typeof(bool), false, true },
                new object[] { "TRUE", typeof(bool), false, true },
                new object[] { "false", typeof(bool), false, false },
                new object[] { "False", typeof(bool), false, false },
                new object[] { "FALSE", typeof(bool), false, false }, new object[] { "abcd", typeof(bool), true, null },
                new object[] { "0", typeof(bool), true, null }, new object[] { "1", typeof(bool), true, null },
                new object[] { "1.0", typeof(float), false, 1.0f }, new object[] { "0.0", typeof(float), false, 0.0f },
                new object[] { "-1.0", typeof(float), false, -1.0f },
                new object[] { "abcd", typeof(float), true, null }, new object[] { "1.0", typeof(double), false, 1.0 },
                ...
                new object[] { "abcd", typeof(decimal), true, null }, new object[] { "", typeof(string), false, "" },
                ...
                new object[]
                    {
                        "ValueA,ValueB", typeof(TestFlagEnum), false, TestFlagEnum.ValueA | TestFlagEnum.ValueB
                    },
                new object[]
                    {
                        "ValueA, ValueB", typeof(TestFlagEnum), false, TestFlagEnum.ValueA | TestFlagEnum.ValueB
                ...
                new object[]
                    {
                        ((int)TestFlagEnum.ValueA).ToString(), typeof(TestFlagEnum), false, TestFlagEnum.ValueA
                    },
                new object[]
                    {
                        ((int)TestFlagEnum.ValueB).ToString(), typeof(TestFlagEnum), false, TestFlagEnum.ValueB
                    },
                new object[]
                    {
                        ((int)(TestFlagEnum.ValueA | TestFlagEnum.ValueB)).ToString(), typeof(TestFlagEnum), false,
                        TestFlagEnum.ValueA | TestFlagEnum.ValueB
                ...
                // Failed before #339
                new object[] { "false", typeof(int), true, 0 }, new object[] { "true", typeof(int), true, 0 }
            };
        }
    }
    ...
    public void ChangeType_flagCounters(string[] testValue, Type destinationType, bool expectFail,
