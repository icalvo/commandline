...
{
    private string NormalizeLineBreaks(string str) => str.Replace("\r", "");
...
line2";
  ...
  line2";
    ...
    {
        var input = "here is some text that contains a veryLongWordThatWontFitOnASingleLine";
        var expected = @"here is some text
that contains a
...
FitOnASingleLine";
    ...
    {
        var input = @"here is some text that needs wrapping";
...
d";
    ...
    {
        var input = "here     is some text with some extra spacing";
...
spacing";
    ...
    {
        var input = "here is some text that contains \n  a veryLongWordThatWontFitOnASingleLine";
        var expected = @"here is some text
that contains
  a
  veryLongWordThatWo
  ntFitOnASingleLine";
    ...
    {
        var input = @"here hippopotamus is some text that needs wrapping";
        var expected = @"here
hippopotamus is
some text that
needs wrapping";
