...
{
    private static readonly StringBuilder _sb = new("test string");
    private static readonly StringBuilder _emptySb = new();
    private static readonly StringBuilder _nullSb = null;

    public static IEnumerable<object[]> GoodStartsWithData =>
        new[] { new object[] { "t" }, new object[] { "te" }, new object[] { "test " }, new object[] { "test string" } };

    public static IEnumerable<object[]> BadTestData =>
        new[]
        {
            new object[] { null }, new object[] { "" }, new object[] { "xyz" },
            new object[] { "some long test string" }
        };

    public static IEnumerable<object[]> GoodEndsWithData =>
        new[]
        {
            new object[] { "g" }, new object[] { "ng" }, new object[] { " string" }, new object[] { "test string" }
        };
