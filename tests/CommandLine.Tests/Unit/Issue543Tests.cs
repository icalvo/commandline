...
public class Issue543Tests
{
    ...
    {
        var result = Parser.Default.ParseArguments<Options>(new[] { "-c", "someConnectionString", "-j", "1234" });
    ...
    {
        var result = Parser.Default.ParseArguments<Verb1Options, Verb2Options>(new[] { "verb1", "-j", "1234" });
    ...
    {
        var result =
            Parser.Default.ParseArguments<Verb1Options, Verb2Options>(new[] { "verb2", "-c", "someConnectionString" });
        ...
        public static IEnumerable<Example> Examples =>
            new[]
            {
                new Example(
                    ...
                    new Options { ConnectionString = "Server=MyServer;Database=MyDatabase", JobId = 5 })
            };
    }
