...
public class Issue6Tests
{
    ...
    [InlineData(
        ...
        new[]
        {
            "copy, cp, cpy    (Default Verb) Copy some stuff", "move, mv", "delete           Delete stuff",
    ...
    [InlineData("move --help", false, new[] { "-a, --alpha    Required.", "--help         Display this help screen." })]
    [InlineData("mv --help", false, new[] { "-a, --alpha    Required.", "--help         Display this help screen." })]
    [InlineData("delete --help", false, new[] { "-b, --beta    Required.", "--help        Display this help screen." })]
    public void Parse_help_option_for_aliased_verbs(string args, bool verbsIndex, string[] expected)
    {
        ...
        // in the help message
        var result = Parser.Default.ParseArguments<AliasedVerbOption2, AliasedVerbOption1, VerbNoAlias>(arguments)
                .WithParsed(o => options = o)
                .WithNotParsed(o => errors = o);

        var message = HelpText.AutoBuild(result, error => error, ex => ex, verbsIndex);

        var helpMessage = message.ToString();
    ...
    [InlineData(
        ...
        new[]
        {
            "move, mv", "delete      Delete stuff", "help        Display more information on a specific command.",
            "version     Display version information."
        })]
    [InlineData(
        "help",
    ...
    [Verb("copy", true, new[] { "cp", "cpy" }, HelpText = "Copy some stuff")]
    ...
    {
        [Option('b', "beta", Required = true)] public string Option { get; set; }
    }
}