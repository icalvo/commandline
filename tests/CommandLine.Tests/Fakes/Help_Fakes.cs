...
internal class Simple_Options_Without_HelpText
{
    [Option('v', "verbose")] public bool Verbose { get; set; }

    [Option("input-file")] public string FileName { get; set; }

    [Option(
        "secert-option",
        Hidden = true,
        HelpText =
            "This is a description for a secert hidden option that should never be visibile to the user via help text.")]
    public string SecertOption { get; set; }
}

internal class Simple_Options_With_HelpText_Set
{
...
internal class Simple_Options_With_HelpText_Set_To_Long_Description
{
    [Option(
        'v',
        "verbose",
        HelpText = "This is the description of the verbosity to test out the wrapping capabilities of the Help Text.")]
    public bool Verbose { get; set; }

    [Option(
        "input-file",
        HelpText =
            "This is a very long description of the Input File argument that gets passed in.  It should  be passed in as a string.")]
    public string FileName { get; set; }
...
internal class Simple_Options_With_HelpText_Set_To_Long_Description_Without_Spaces
{
...
internal class Options_With_Usage_Attribute
{
    ...
    [Value(0, HelpText = "Value.")] public string Value { get; set; }
    ...
    public static IEnumerable<Example> Examples
    {
        get
        {
            yield return new Example(
                "Normal scenario",
                new Options_With_Usage_Attribute { InputFile = "file.bin", OutputFile = "out.bin" });
            yield return new Example(
                "Logging warnings",
                UnParserSettings.WithGroupSwitchesOnly(),
                new Options_With_Usage_Attribute { InputFile = "file.bin", LogWarning = true });
            yield return new Example(
                "Logging errors",
                new[] { UnParserSettings.WithGroupSwitchesOnly(), UnParserSettings.WithUseEqualTokenOnly() },
                new Options_With_Usage_Attribute { InputFile = "file.bin", LogError = true });
...
[Verb(
    "secert",
    Hidden = true,
    HelpText = "This is a secert hidden verb that should never be visible to the user via help text.")]
...
public class Add_Verb_With_Usage_Attribute
{
    ...
    public static IEnumerable<Example> Examples
    {
        get { yield return new Example("Forcing file", new Add_Verb { FileName = "README.md", Force = true }); }
    }
}
...
public class Commit_Verb_With_Usage_Attribute
{
    ...
    public static IEnumerable<Example> Examples
    {
        get { yield return new Example("Committing work", new Commit_Verb_With_Usage_Attribute { Patch = true }); }
    }
}
...
public class Clone_Verb_With_Usage_Attribute
{
    ...
    [Value(0, MetaName = "URLS", HelpText = "A list of url(s) to clone.")]
    ...
    public static IEnumerable<Example> Examples
    {
        get
        {
            yield return new Example(
                "Basic cloning",
                new Clone_Verb_With_Usage_Attribute { Urls = new[] { "https://github.com/gsscoder/csharpx" } });
            yield return new Example(
                "Cloning quietly",
                new Clone_Verb_With_Usage_Attribute
                {
                    Quiet = true, Urls = new[] { "https://github.com/gsscoder/railwaysharp" }
                });
            yield return new Example(
                "Cloning without hard links",
                new Clone_Verb_With_Usage_Attribute
                {
                    NoHardLinks = true, Urls = new[] { "https://github.com/gsscoder/csharpx" }
                });
        }
    }
}
