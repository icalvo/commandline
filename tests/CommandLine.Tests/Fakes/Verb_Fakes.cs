...
[Verb("add", true, HelpText = "Add file contents to the index.")]
...
public class Clone_Verb
{
    ...
    [Value(0)] public IEnumerable<string> Urls { get; set; }
}

[Verb("sequence", HelpText = "Sequence options test.")]
public class SequenceOptions
{
    [Option("long-seq", Separator = ';')] public IEnumerable<long> LongSequence { get; set; }

    [Option('s', Min = 1, Max = 100, Separator = ',')]
    public IEnumerable<string> StringSequence { get; set; }
}

internal abstract class Base_Class_For_Verb
{
    [Option(
        'p',
        "patch",
...
internal class Derived_Verb : Base_Class_For_Verb
{
...
[Verb("test")]
internal class Verb_With_Option_And_Value_Of_String_Type
{
...
[Verb("default1", true)]
internal class Default_Verb_One
{
    [Option('t', "test-one")] public bool TestValueOne { get; set; }
}

[Verb("default2", true)]
internal class Default_Verb_Two
{
    [Option('t', "test-two")] public bool TestValueTwo { get; set; }
}

[Verb(null, true)]
internal class Default_Verb_With_Empty_Name
{
    [Option('t', "test")] public bool TestValue { get; set; }
}
