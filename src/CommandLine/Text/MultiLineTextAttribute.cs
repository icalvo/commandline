...
public abstract class MultilineTextAttribute : Attribute
{
    ...
    protected MultilineTextAttribute(string line1, string line2) : this(
        line1,
        line2,
        string.Empty,
        string.Empty,
    ...
    protected MultilineTextAttribute(string line1, string line2, string line3) : this(
        line1,
        line2,
        line3,
        string.Empty,
    ...
    protected MultilineTextAttribute(string line1, string line2, string line3, string line4) : this(
        line1,
        line2,
        line3,
        line4,
    ...
    public virtual string Value
    {
        get
        {
            ...
            for (var i = 0; i < GetLastLineWithText(strArray); i++) value.AppendLine(strArray[i]);
