...
internal static class StringBuilderExtensions
{
    ...
    public static StringBuilder AppendFormatWhen(this StringBuilder builder, bool condition, string format,
        params object[] args) =>
    ...
    public static StringBuilder AppendIf(this StringBuilder builder, bool condition, string ifTrue, string ifFalse) =>
        condition ? builder.Append(ifTrue) : builder.Append(ifFalse);
    ...
    public static string SafeToString(this StringBuilder builder) =>
        builder == null ? string.Empty : builder.ToString();

    public static int SafeLength(this StringBuilder builder) => builder == null ? 0 : builder.Length;

    public static StringBuilder TrimEnd(this StringBuilder builder, char c) =>
        builder.Length > 0 ? builder.Remove(builder.Length - 1, 1) : builder;
    ...
    public static StringBuilder TrimEndIfMatchWhen(this StringBuilder builder, bool condition, char c) =>
        condition ? builder.TrimEndIfMatch(c) : builder;
