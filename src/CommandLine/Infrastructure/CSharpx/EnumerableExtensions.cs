...
internal static class EnumerableExtensions
{
    ...
    public static Maybe<T> TryHead<T>(this IEnumerable<T> source)
    {
        ...
        {
            return e.MoveNext() ? Maybe.Just(e.Current) : Maybe.Nothing<T>();
        }
    }
    ...
    public static Maybe<IEnumerable<T>> AsMaybe<T>(this IEnumerable<T> source)
    {
        using (var e = source.GetEnumerator())
        {
            return e.MoveNext() ? Maybe.Just(source) : Maybe.Nothing<IEnumerable<T>>();
        }
    }
#endif

    private static IEnumerable<TSource> AssertCountImpl<TSource>(IEnumerable<TSource> source, int count,
    ...
    private static IEnumerable<TSource> ExpectingCountYieldingImpl<TSource>(IEnumerable<TSource> source, int count,
        Func<int, int, Exception> errorSelector)
    {
        var iterations = 0;
    ...
    public static TResult Fold<T, TResult>(this IEnumerable<T> source, Func<T, TResult> folder) =>
        FoldImpl(source, 1, folder, null, null, null);
    ...
    public static TResult Fold<T, TResult>(this IEnumerable<T> source, Func<T, T, TResult> folder) =>
        FoldImpl(source, 2, null, folder, null, null);
    ...
    public static TResult Fold<T, TResult>(this IEnumerable<T> source, Func<T, T, T, TResult> folder) =>
        FoldImpl(source, 3, null, null, folder, null);
    ...
    public static TResult Fold<T, TResult>(this IEnumerable<T> source, Func<T, T, T, T, TResult> folder) =>
        FoldImpl(source, 4, null, null, null, folder);

    private static TResult FoldImpl<T, TResult>(IEnumerable<T> source, int count, Func<T, TResult>? folder1,
    ...
    {
        if (source is MaterializedEnumerable<T> || source.GetType().IsArray) return source;
    ...
    public static IEnumerable<T> Intersperse<T>(this IEnumerable<T> source, T element)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            if (i != last) yield return element;
        }
    }
