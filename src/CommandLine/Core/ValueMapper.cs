...
internal static class ValueMapper
{
    public static Result<
            IEnumerable<SpecificationProperty>, Error> MapValues(IEnumerable<SpecificationProperty> specProps,
        IEnumerable<string> values, Func<IEnumerable<string>, Type, bool, Maybe<object>> converter)
    {
    ...
    private static IEnumerable<Tuple<SpecificationProperty, Maybe<Error>>> MapValuesImpl(
        IEnumerable<SpecificationProperty> specProps, IEnumerable<string> values,
        Func<IEnumerable<string>, Type, bool, Maybe<object>> converter)
    {
        if (specProps.Empty()) yield break;
        ...
        yield return converter(taken, pt.Property.PropertyType, pt.Specification.TargetType != TargetType.Sequence)
            .MapValueOrDefault(
    ...
    private static Maybe<int> CountOfMaxNumberOfValues(this Specification specification)
    {
        switch (specification.TargetType)
        {
            ...
            case TargetType.Sequence:
                if (specification.Max.IsJust()) return Maybe.Just(specification.Max.FromJustOrFail());
                break;
        }
