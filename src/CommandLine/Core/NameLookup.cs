...
{
    public static NameLookupResult Contains(string name, IEnumerable<OptionSpecification> specifications,
        StringComparer comparer)
    {
        OptionSpecification? option =
            specifications.FirstOrDefault(a => name.MatchName(a.ShortName, a.LongNames, comparer));
