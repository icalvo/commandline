...
internal static class KeyValuePairHelper
{
    ...
    {
        return tokens.Group(2).Select(g => g[0].Text.ToKeyValuePair(g[1].Text));
    }
    ...
    private static KeyValuePair<string, IEnumerable<string>> ToKeyValuePair(this string value, params string[] values) => new(value, values);
}
