...
public abstract class Error : IEquatable<Error>
{
    ...
    {
        if (obj is Error other) return Equals(other);
...
public abstract class TokenError : Error, IEquatable<TokenError>
{
    ...
    public override bool Equals(object? obj)
    {
        if (obj is TokenError other) return Equals(other);
    ...
    /// <returns>
    ///     <value>true</value>
    ///     if this instance of <see cref="CommandLine.TokenError" /> and <paramref name="other" /> have the same value;
    ///     otherwise,
    ///     <value>false</value>
    ///     .
    /// </returns>
...
public abstract class NamedError : Error, IEquatable<NamedError>
{
    ...
    /// <returns>
    ///     <value>true</value>
    ///     if this instance of <see cref="CommandLine.NamedError" /> and <paramref name="other" /> have the same value;
    ///     otherwise,
    ///     <value>false</value>
    ///     .
    /// </returns>
...
{
    internal HelpVerbRequestedError(string? verb, Type? type, bool matched) : base(
...
{
    internal HelpVerbNotFoundError(string verb) : base(ErrorType.HelpVerbNotFoundError, false) => Verb = verb;
...
{
    internal SetValueExceptionError(NameInfo nameInfo, Exception? exception, object value) : base(
        ErrorType.SetValueExceptionError,
        nameInfo)
    {
        Exception = exception;
        this.Value = value;
...
public sealed class MissingGroupOptionError : Error, IEquatable<Error>, IEquatable<MissingGroupOptionError>
{
    ...
    {
        if (obj is MissingGroupOptionError other) return Equals(other);
...
public sealed class GroupOptionAmbiguityError : NamedError
{
    ...
    internal GroupOptionAmbiguityError(NameInfo option) : base(ErrorType.GroupOptionAmbiguityError, option) =>
        Option = option;
}
...
public sealed class MultipleDefaultVerbsError : Error
{
    ...
    internal MultipleDefaultVerbsError() : base(ErrorType.MultipleDefaultVerbsError)
    {
    }
}
