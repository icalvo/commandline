...
public sealed class NameInfo : IEquatable<NameInfo>
{
    ...
    ///     rather than options.
    /// </summary>
    public static readonly NameInfo EmptyName = new(string.Empty, new string[0]);
    ...
    public string NameText =>
        ShortName.Length > 0 && LongNames.Length > 0
    ...
    /// <returns>
    ///     <value>true</value>
    ///     if this instance of <see cref="CommandLine.NameInfo" /> and <paramref name="other" /> have the same value;
    ///     otherwise,
    ///     <value>false</value>
    ///     .
    /// </returns>
